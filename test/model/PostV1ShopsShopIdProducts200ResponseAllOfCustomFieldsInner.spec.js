...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellAuth.PostV1ShopsShopIdProducts200ResponseAllOfCustomFieldsInner();
  });
  ...
  describe('PostV1ShopsShopIdProducts200ResponseAllOfCustomFieldsInner', function() {
    it('should create an instance of PostV1ShopsShopIdProducts200ResponseAllOfCustomFieldsInner', function() {
      // uncomment below and update the code to test PostV1ShopsShopIdProducts200ResponseAllOfCustomFieldsInner
      //var instance = new SellAuth.PostV1ShopsShopIdProducts200ResponseAllOfCustomFieldsInner();
      //expect(instance).to.be.a(SellAuth.PostV1ShopsShopIdProducts200ResponseAllOfCustomFieldsInner);
    });
