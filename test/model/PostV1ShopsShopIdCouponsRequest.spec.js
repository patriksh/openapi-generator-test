...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellAuth.PostV1ShopsShopIdCouponsRequest();
  });
  ...
  describe('PostV1ShopsShopIdCouponsRequest', function() {
    it('should create an instance of PostV1ShopsShopIdCouponsRequest', function() {
      // uncomment below and update the code to test PostV1ShopsShopIdCouponsRequest
      //var instance = new SellAuth.PostV1ShopsShopIdCouponsRequest();
      //expect(instance).to.be.a(SellAuth.PostV1ShopsShopIdCouponsRequest);
    });
