...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellAuth.PostV1ShopsShopIdProductsRequest();
  });
  ...
  describe('PostV1ShopsShopIdProductsRequest', function() {
    it('should create an instance of PostV1ShopsShopIdProductsRequest', function() {
      // uncomment below and update the code to test PostV1ShopsShopIdProductsRequest
      //var instance = new SellAuth.PostV1ShopsShopIdProductsRequest();
      //expect(instance).to.be.a(SellAuth.PostV1ShopsShopIdProductsRequest);
    });
